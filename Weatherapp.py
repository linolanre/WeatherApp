...
st.markdown("<h6 style = 'top_margin: 0rem;color: #FFB4B4'>Built by LinoLanre Consult</h6>", unsafe_allow_html = True)
st.image('pngwing.com (5).png', width =500)

st.subheader("Ask Your Weather Related Questions, Lino Will Give A Reply")
